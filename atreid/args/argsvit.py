...
def create_argparser():
    defaults = dict(
        ...
        d='atustc',
        v=1, gpu=0, wait=True, t=0.0, mb=100, test=False,
        drop=0.2, stride=16,
        optim='sgd', lr=0.008, wd=0.0005, dwd=True,
        ...
        md1=[3, 4, 2, 0], md2=[3, 4, 2, 0],
        d1=0.6, d2=6,
        seed=0, workers=4, trial=1,
        test_epoch=999, last_test=0, test_batch=256, flip=True
    )
