...
import random
from dataset.paths import resolve_dataset_root


class cuhk(object):
    def __init__(self, data_dir=None, data_root_config=None):
        self.data_dir = resolve_dataset_root('cuhk', data_dir, data_root_config)
        # 0465_c1_4527.png
        # pid cid relabel begin from 0, camid begin from 1
        print(f"=> loaded cuhk03")
        print(f"  --------------------------------------------------------------------")
